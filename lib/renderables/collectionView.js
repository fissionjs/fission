...
var createCollection = require('../data/createCollection');
...
module.exports = function(config) {
  ...
  // store fission scope to access
  // fission sibling functions in component
  var FissionScope = this;
  ...
  var CollectionViewMixin = {
    ...
    _initialize: function() {
      ...
      var sync = FissionScope.getSync(this.props.model, FissionScope.options);
      var ctor = createCollection(this.props.model);
